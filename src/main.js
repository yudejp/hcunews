...
const messages = {
  en: {
    message: {
      ...
      desc_how_1: 'IFTTT obtains the RSS data of HCU webpage, and when new article is available it posts notification to Twitter.',
  ...
  ja: {
    message: {
      ...
      desc_how_1: 'IFTTT によって広島市立大学WebページのRSSを取得し、新しい記事が投稿されていたらツイートされます。',
      desc_how_2: '尚、次のURLに更新があったときのみツイートされます。',
      misc: 'その他',
      desc_misc_1: '同じ記事が複数回投稿されることがありますが、これはIFTTTの仕様上のものです。',
      related_links: '関連リンク',
      contact: '連絡先',
      mail: '電子メール',
